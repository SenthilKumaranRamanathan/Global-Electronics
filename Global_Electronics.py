...
def customer_data():
        # Load dataset
        customers = pd.read_csv('C:\GE\DataSet\Customers.csv', encoding='ISO-8859-1')
        ...
        customers.to_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Customers.csv', index=False)
        print(customers)
        print("Customers data cleaning completed.")

def sales_data():
    # Load dataset
    sales = pd.read_csv('C:\GE\DataSet\Sales.csv', encoding='ISO-8859-1')
    ...
    # Save cleaned dataset
    sales.to_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Sales.csv', index=False)
...
def stores_data():
    # Load dataset
    stores = pd.read_csv('C:\GE\DataSet\Stores.csv', encoding='ISO-8859-1')
    ...
    # Save cleaned dataset
    stores.to_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Stores.csv', index=False)

    print("Stores data cleaning completed.")

def product_data():
    # Load dataset
    products = pd.read_csv('C:\GE\DataSet\Products.csv', encoding='ISO-8859-1')
    ...
    # Save cleaned dataset
    products.to_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Products.csv', index=False)
...
def exchange_rate_data():
    # Load dataset
    exchange_rates = pd.read_csv('C:\GE\DataSet\Exchange_Rates.csv', encoding='ISO-8859-1')
    ...
    # Save cleaned dataset
    exchange_rates.to_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Exchange_Rates.csv', index=False)

    print("Exchange rates data cleaning completed.") 
    
def merge_data():
    # Load cleaned datasets
    customers = pd.read_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Customers.csv', encoding='ISO-8859-1')
    sales = pd.read_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Sales.csv', encoding='ISO-8859-1')
    stores = pd.read_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Stores.csv', encoding='ISO-8859-1')
    products = pd.read_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Products.csv', encoding='ISO-8859-1')
    exchange_rates = pd.read_csv('C:\GE\DataSet\Cleaned_dataset\Cleaned_Exchange_Rates.csv', encoding='ISO-8859-1')
    ...
    sales_customers_stores_products.to_csv('C:\GE\DataSet\Cleaned_dataset\Merged_data.csv', index=False)
...
def load_all_data():
        # Load the CSV data
        file_path = 'C:\GE\DataSet\Cleaned_dataset\merged_data.csv'
